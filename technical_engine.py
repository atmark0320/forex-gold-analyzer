...
def generate_trade_plan(
    ...
    return TradePlan(
        direction, score, confidence, regime, entry_type, round(entry, 5), round(stop, 5),
        round(target1, 5), round(target2, 5), round(risk, 5), cfg.target1_r, cfg.target2_r,
        tuple(reasons), invalidation,
    )
...
__all__ = [
    "StrategyConfig", "TradePlan", "add_indicators", "resample_ohlc", "dow_structure",
    "timeframe_snapshot", "generate_trade_plan", "analyze_multi_timeframe",
]
